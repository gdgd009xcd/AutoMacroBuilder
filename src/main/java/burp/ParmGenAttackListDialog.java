...
//    private java.awt.Frame parentwin;
    ...
    private void initComponents() {
        ...
        PatternList.setModel(new javax.swing.AbstractListModel() {
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        // TODO add your handling code here:
        DefaultComboBoxModel cmodel = (DefaultComboBoxModel)AttackList.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParmGenAttackListDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ParmGenAttackListDialog dialog = new ParmGenAttackListDialog(null, true, "");
    ...
    private javax.swing.JComboBox AttackList;
