...
import automacrobuilder.ParmGenTWait;
import automacrobuilder.ParmVars;
import automacrobuilder.GSONSaveObject.PRequestResponses;
...
public class ParmGenMacroTrace {
    ...
    public ParmGenMacroTrace(IBurpExtenderCallbacks _callbacks){
