...
public class ParmGenTamperOpt extends javax.swing.JDialog implements interfaceParmGenWin {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParmGenTamperOpt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ParmGenTamperOpt dialog = new ParmGenTamperOpt(null);
    ...
    private javax.swing.JComboBox PayloadPosition;
    private javax.swing.JComboBox TargetParam;
